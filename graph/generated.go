...
func (ec *executionContext) field_Mutation_createUser_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNCreateUserInput2go_graphql_ent_hello_worldᚋgraphᚋmodelᚐCreateUserInput(ctx, tmp)
	}
...
func (ec *executionContext) _Mutation_createUser(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*ent.User)
	fc.Result = res
	return ec.marshalNUser2ᚖgo_graphql_ent_hello_worldᚋentᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_users(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*ent.User)
	fc.Result = res
	return ec.marshalNUser2ᚕᚖgo_graphql_ent_hello_worldᚋentᚐUserᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNCreateUserInput2go_graphql_ent_hello_worldᚋgraphᚋmodelᚐCreateUserInput(ctx context.Context, v any) (model.CreateUserInput, error) {
...
func (ec *executionContext) marshalNUser2go_graphql_ent_hello_worldᚋentᚐUser(ctx context.Context, sel ast.SelectionSet, v ent.User) graphql.Marshaler {
	return ec._User(ctx, sel, &v)
}

func (ec *executionContext) marshalNUser2ᚕᚖgo_graphql_ent_hello_worldᚋentᚐUserᚄ(ctx context.Context, sel ast.SelectionSet, v []*ent.User) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNUser2ᚖgo_graphql_ent_hello_worldᚋentᚐUser(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNUser2ᚖgo_graphql_ent_hello_worldᚋentᚐUser(ctx context.Context, sel ast.SelectionSet, v *ent.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
